...
# Normalized newsletter form names for efficient comparison
NORMALIZED_NEWSLETTER_FORM_NAMES = [
	"newsletter",
	"newsletter signup",
	"newsletter form",
]
...
def auto_enroll_lead_in_newsletter_campaign(doc, method=None):
	...
	is_newsletter_signup = (
		doc.source == "Webflow"
		and doc.get("webflow_form_name")
		and doc.webflow_form_name.lower().replace("-", " ").replace("_", " ")
		in NORMALIZED_NEWSLETTER_FORM_NAMES
	)
