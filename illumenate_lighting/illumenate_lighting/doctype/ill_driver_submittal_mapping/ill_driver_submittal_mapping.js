...
frappe.ui.form.on("ilL-Driver-Submittal-Mapping", {
	...
	show_fields_button: function (frm) {
		...
		frappe.call({
			method: "illumenate_lighting.illumenate_lighting.doctype.ill_driver_submittal_mapping.ill_driver_submittal_mapping.get_doctype_fields",
			...
			callback: function (r) {
				if (r.message) {
					frm.set_df_property(
						...
						"options",
						build_driver_fields_table(r.message, frm)
					);
				}
			},
		});
...
function build_driver_fields_table(fields, frm) {
